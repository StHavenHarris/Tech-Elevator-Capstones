...
public class Transfer {
    ...
    public Transfer(int transferId, String transferType, String transferStatus, String fromAccount, int fromAccountId, String toAccount,
    ...
    public Transfer(int transferId, String transferType, String transferStatus, int fromAccountId, int toAccountId,
            BigDecimal amount) {
        this.transferId = transferId;
        this.transferType = transferType;
        this.transferStatus = transferStatus;
